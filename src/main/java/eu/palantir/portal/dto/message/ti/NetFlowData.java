...
public class NetFlowData implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(NetFlowData.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
                .append('[');
        sb.append("timeStart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NetFlowData) == false) {
            return false;
        }
        NetFlowData rhs = ((NetFlowData) other);
